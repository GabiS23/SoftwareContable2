<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SairaSoftOnline.index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="row  border-bottom white-bg dashboard-header">
                    ...
                    <div class="col-md-3">
                        <h2 id="user_name" runat="server">Bienvenido Desconocido</h2>
