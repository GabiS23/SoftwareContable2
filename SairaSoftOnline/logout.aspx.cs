...
namespace SairaSoftOnline
{
    public partial class logout1 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sql = "select count(*), concat(DU.nombre, ' ', DU.apellido) from usuario US, dato_usuario DU where DU.usuario_idusuario = US.idusuario and cuenta = '" + TextBox1.Text + "' and contrasena = '" + TextBox2.Text + "' and estado = 'Activo'";
